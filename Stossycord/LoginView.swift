        ...
        VStack {
            Text("StossyCord - a custom Discord Client")
                ...
                .alert(isPresented: $showingAlert) {
                    Alert(title: Text("Alert"), message: Text("StossyCord is a pre release software - use at your own risk!"), dismissButton: .default(Text("I Understand")))
                }
            Text("Login Options:")
                .fontWeight(.bold)
                .padding(.bottom, 20)
    ...
    var body: some View {
        VStack {
            Text("Login to Discord")
                ...
                .alert(isPresented: $showingAlert) {
                    Alert(title: Text("Alert"), message: Text("This login method is buggy and unstable - use at your own risk"), dismissButton: .default(Text("I Understand")))
                }
                    HStack {
